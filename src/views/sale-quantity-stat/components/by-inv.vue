  ...
  <div>
    <div class="by-inv-header">
      ...
      <Select v-model="sort_type" style="width:140px;margin-left: 10px;">
        ...
        <Option value="sort_by_quantity">按总销量排序</Option>
      </Select>
    ...
    <div class="by-inv-content">
      <div id="stat-char" class="by-inv-char"></div>
...
<script>
  ...
  import {
    ...
    getSaleQuantityChartByInventory,
  } from '@/api/app.js';
  ...
  export default {
    ...
    methods: {
      ...
      handleSearchResult() {
        ...
        getSaleQuantityChartByInventory().then((response) => {
      ...
      handleChartClick(params) {
        ...
        getSaleQuantityDetailByInventory().then((response) => {
          if (response.data.retrun_code === "000000") {
